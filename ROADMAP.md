...
- [~] Hybrid retrieval strategy: vector + keyword/full-text + graph/entity/structured expansion with deterministic fusion is started; tunable weights and production full-text indexes remain guided by [`docs/portfolio-chat-service/12-retrieval-agent-hybrid-reference.md`](./docs/portfolio-chat-service/12-retrieval-agent-hybrid-reference.md).
