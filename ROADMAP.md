...
- [x] Agentic RAG V1 contract surface: `my_agents/agents/agentic_rag/` names ContextForge as the Retrieval Agent and adds deterministic planner/verifier coverage for compact localized ko/en trace stages without moving authorization/retrieval/provider work out of service layers.
