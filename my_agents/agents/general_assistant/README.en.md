...
| authorized documents | service-layer `retrieved_context` | Already permission-filtered before entering the graph; can include ambient system/project knowledge for authenticated users |
